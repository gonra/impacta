package com.atos.atospessoal.controller;
...
import com.atos.atospessoal.repositories.PessoaRepository;
...
public class PessoaController {
	...
	@PostMapping("/pessoa")
	public ResponseEntity<Pessoa> savePizza(@RequestBody Pessoa pessoa) {
